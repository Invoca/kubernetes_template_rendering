  ...
  describe "#render" do
    ...
    context "with yaml.erb files" do
      ...
      context "when variable overrides are provided" do
        ...
        it "does not add a comment with the variable overrides used" do
          return_erb_on_file_read
          expect(render_template).to_not include("# Variable overrides used:")
        end

        it "still emits the autogenerated comment" do
          return_erb_on_file_read
          expect(render_template).to include("# This file is autogenerated from #{path}")
        end
      end
